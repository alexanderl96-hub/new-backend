...
const { getAll, getOne, getOneFromStats, postOne, updateOne, deleteOne } = require("../queries/playersCareerStats")
...
router.get("/careerPlayer/:players_id", async (req, res) => { 
    try {
